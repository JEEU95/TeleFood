...
public class frmPedidos extends javax.swing.JFrame {
     ...
     */
    public frmPedidos(int num,TeleFood pedidos, int id) throws Exception {
        initComponents();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try {
            ventana = new frmPedidosProductos(num,pedidos,id);
    ...
    private void btnSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSiguienteActionPerformed
        ...
        try {
            if (jConsumidor.isSelected()) {
                ventana = new frmFactura(num, true,pedidos,id);
              
            } else {
                ventana = new frmFactura(num, false,pedidos,id);
            }
        } catch (Exception e) {
